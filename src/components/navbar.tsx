      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex items-center justify-between h-14">
          ...
          <div className="flex items-center gap-6">
            <button onClick={() => setActiveTab('home')} className="text-lg font-semibold text-neutral-900 tracking-tight">
              UstozPro
            </button>
            {/* Desktop menu */}
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={handleLogout} className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-md text-sm font-medium text-neutral-600 hover:bg-neutral-100 transition-colors">
        ...
        {menuOpen && (
          <div className="lg:hidden pb-3 space-y-0.5 border-t border-neutral-100 pt-2">
            ...
            <button onClick={handleLogout} className="w-full text-left px-3 py-1.5 rounded-md text-sm font-medium text-red-600 hover:bg-red-50">
              Chiqish
            </button>
          </div>
        )}
